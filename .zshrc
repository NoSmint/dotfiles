...
# enable color support of ls, less and man, and also add handy aliase<s
...
if [ -f /usr/share/zsh-autosuggestions/zsh-autosuggestions.zsh ]; then
    ...
    ZSH_AUTOSUGGEST_HISTORY_IGNORE="cd*:ll*:la*"
fi
...
plugins=(sudo git copybuffer dirhistory z)
source ~/Git/zsh-hist/zsh-hist.plugin.zsh
source ~/.profile
source $ZSH/oh-my-zsh.sh

DEFAULT_USER=nosmint

zstyle ':completion:*' menu yes select interactive
zstyle ':completion:*' auto-description 'specify: %d'
zstyle ':completion:*' completer _expand _complete
zstyle ':completion:*' format '%F{208}Completing %d%f'
...
# recursively Load every "custom_<script>.zsh" file in ~/.scripts folder
for file in $(fd "*.zsh" ~/.scripts/zsh --type file --glob) ; do source $file ; done
